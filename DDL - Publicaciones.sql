...
create table autores(
	...
	tipoAutor nvarchar(50) not null)
...
create table editoriales(
	Id int identity not null primary key, 
	nombre nvarchar(100) not null, 
	ubicacionGeograficaId int not null, 
	constraint fk_ubicacionGeografica foreign key (ubicacionGeograficaId) 
	references dbo.ubicacionGeografica(Id) on delete cascade on update cascade)
...
create table publicaciones(
	Id int identity not null primary key, 
	nombre nvarchar(100) not null, 
	tiposId int not null, editorialId int not null, 
	descriptores nvarchar(1000) not null,
	serie int not null, 
	volumen int,
